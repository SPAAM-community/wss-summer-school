...
| 10:30-12:30 | Practical        | BareBonesBash                                                           | Introduction to R and the tidyverse & Introduction to Python and Pandas         | Taxonomic Profiling, OTU Tables and Visualisation        | Genome assembly                    | - Decontamination (30m)<br>- General Authentication Lecture and Practical (1h) <br>- Authentication at Scale Lecture (30m) |
...
- **Practical** Authentication and Decontamination (eukaryotes): _Giulia Zampirolo and Aleksandra Laura Pach_
  - How can I validate my DNA is ancient? What sort of analyses can convince ourselves and a reviewer we have good preservation?
- **Practical** Ancient Metagenomic Pipelines: _Nikolay Oskolkov, James Fellows Yates and Jasmin Frangenberg_
